...
const translations = {
  en: {
    ...
    visionDescription: 'Mantra Puja is a comprehensive platform for booking Hindu pujas (rituals), astrology readings, and spiritual services online. Our mission is to make authentic Vedic rituals accessible to everyone, everywhere. Explore our vast library of bhajans, mantras, and devotional content.',
  ...
  hi: {
    ...
    themeLight: 'लाइट मोड',
    themeDark: 'डार्क मोड',
    aboutApp: 'मंत्र पूजा के बारे में',
    ...
    visionDescription: 'मंत्र पूजा हिंदू पूजाओं (अनुष्ठानों), ज्योतिष रीडिंग और आध्यात्मिक सेवाओं की ऑनलाइन बुकिंग के लिए एक व्यापक मंच है। हमारा मिशन वैदिक अनुष्ठानों को हर जगह, हर किसी के लिए सुलभ बनाना है। भजनों, मंत्रों और भक्ति सामग्री की हमारी विशाल लाइब्रेरी का आनंद लें।',
